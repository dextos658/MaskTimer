package si.facemask.catalog.imagecatalog.services.beans;
...
import si.facemask.catalog.imagecatalog.models.converters.ImageMetadataConverter;
...
public class ImageMetadataBean {
    ...
    public ImageMetadata createImageMetadata(ImageMetadata imageMetadata) {
        ...
        if (imageMetadataEntity.getMaskId() == null) {
    ...
    public ImageMetadata putImageMetadata(Integer id, ImageMetadata imageMetadata) {
        ...
        try {
            beginTx();
            updatedImageMetadataEntity.setMaskId(c.getMaskId());
